...
# Fetch command line arguments / input from user while running this script
GITHUB_REPOSITORY=$1
...
curl -L \
  ...
  https://api.github.com/repos/${GITHUB_OWNER}/${GITHUB_REPOSITORY}/collaborators | jq -r '.[].login'
